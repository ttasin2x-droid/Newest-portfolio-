...
// --- SYSTEM MAINTENANCE CHECK (NEW ADDITION) ---
// This checks if the site is offline immediately upon loading
...
onValue(statusRef, (snapshot) => {
    ...
    if (data && data.isLive === false) {
        document.body.innerHTML = `
            <div style="height:100vh; background:#0f172a; color:white; display:flex; flex-direction:column; align-items:center; justify-content:center; font-family:sans-serif; text-align:center;">
                <h1 style="font-size:3rem; margin-bottom:10px;">⚠️</h1>
                <h2 style="font-size:2rem; margin:0;">System Offline</h2>
                <p style="color:#94a3b8; margin-top:10px;">The portfolio is currently undergoing maintenance.<br>Please try again later.</p>
            </div>
        `;
    }
});
...
if(galleryGrid) { // Safety check to ensure element exists
